document.addEventListener('DOMContentLoaded', () => {
        ...
        filtered.forEach((finding, index) => {
            ...
            item.innerHTML = `
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 4px;">
                    ...
                    <div class="badge-pill" style="padding: 2px 6px; font-size: 0.55rem; background: var(--neo-input);">${finding.method || 'API'}</div>
                </div>
                ...
                <div style="font-size: 0.7rem; color: var(--neo-text-muted); font-family: var(--font-mono); overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${finding.url || 'No Endpoint'}</div>
            `;
    ...
    function renderDetailView(finding) {
        ...
        const priorityColor = priorityBadge === 'P0' ? '#ef4444' : (priorityBadge === 'P1' ? '#f59e0b' : (priorityBadge === 'P2' ? '#3b82f6' : '#10b981'));
        ...
        findingsDetailSide.innerHTML = `
            <div style="margin-bottom: 2rem; border-bottom: 1px solid var(--neo-border); padding-bottom: 1.5rem;">
                ...
                <div style="display: flex; gap: 0.75rem; flex-wrap: wrap;">
                    ...
                    <span class="badge-pill" style="color: ${priorityColor}; border-color: ${priorityColor}44; background: ${priorityColor}11;">Priority ${priorityBadge}</span>
                    <span class="badge-pill" style="color: var(--neo-blue); border-color: var(--neo-blue)44; background: var(--neo-blue)11;">Confidence: ${finding.confidence || 'High'}</span>
                </div>
            </div>

            <div class="flex flex-col gap-6">
                <div class="detail-section" style="padding: 0; border: none;">
                    <span class="detail-label">Endpoint Vulnerability Description</span>
                ...
                <div class="detail-section" style="padding: 1.5rem; background: rgba(0,0,0,0.2); border-radius: 12px; border: 1px solid var(--neo-border);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        ...
                        <div style="font-family: var(--font-mono); font-size: 0.65rem; color: var(--neo-text-muted);">Engine: XGBoost/NLP</div>
                    </div>
                ...
                <div class="detail-section" style="padding: 0; border: none;">
                    <span class="detail-label">Evidence / Payload</span>
