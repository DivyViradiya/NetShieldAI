document.addEventListener('DOMContentLoaded', () => {
    ...
    // History
    const zapHistoryBtn = document.getElementById('nmapHistoryBtn'); 
    ...
    // Initialize
    setTimeout(() => appendLog('System Ready. Initializing Application Security Audit interface...'), 100);
    checkReportAvailability(); // Replaces old checkReportStatus
    fetchAndDisplayResults();
    checkScanStatus();
    setupLogStream();
});